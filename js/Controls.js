...
export default class Controls{
    ...
    handleMouseMove(event) {
        ...
        if (event.movementX || event.movementY) {
            ...
            this.player.dir.y += event.movementY * 0.01; // Adjust sensitivity as needed
        }
        console.log(this.player.dir.x, this.player.dir.y); // Debugging output to see direction changes
    }
